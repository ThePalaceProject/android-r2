...
rm -rf mathjax-unpack-font
mkdir -p mathjax-unpack-font
tar -C mathjax-unpack-font -x -v -f "mathjax-newcm-font-${MATHJAX_VERSION}.tgz"
...
cp mathjax-unpack-font/package/chtml/woff2/*.woff2 mathjax-dist/fonts/mathjax-newcm-font/chtml/woff2/
cp mathjax-unpack-font/package/chtml/dynamic/*.js  mathjax-dist/fonts/mathjax-newcm-font/chtml/dynamic/
